...
### TYPE 3:B - GENERIC CLASS-BASED VIEWS ###
...
### TYPE 3:A - MIXIN CLASS-BASED VIEWS ##
'''
from snippets.models import Snippet
from snippets.serializers import SnippetSerializer
...
### TYPE 3 - Code (explicit class based views)
'''
from snippets.models import Snippet
from snippets.serializers import SnippetSerializer
...
# format=None allows user to specify if they want a response in json for the html api page
...
# http --debug    : option lets you view request data, parameters, headers, etc
